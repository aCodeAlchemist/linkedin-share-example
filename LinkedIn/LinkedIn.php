...
class LinkedIn
{
	...
	const SCOPE_WRITE_SHARE = 'w_share'; // Send messages and invitations to connect as you
	 ...
	 * @return array
	 */
	public function fetch($endpoint, array $payload = array(), $method = 'GET', array $headers = array(), array $curl_options = array(), $flag = false)
	{
		$endpoint = self::API_BASE . '/' . trim($endpoint, '/\\') . '?oauth2_access_token=' . $this->getAccessToken();
		$headers[] = 'x-li-format: json';
		
		return $this->_makeRequest($endpoint, $payload, $method, $headers, $curl_options, true);
	}
	 ...
	 * @return array
	 */
	protected function _makeRequest($url, array $payload = array(), $method = 'GET', array $headers = array(), array $curl_options = array(), $flag = false)
	{
		...
		protected function _altMakeRequest($url, array $payload = array(), $method = 'GET', array $headers = array(), array $curl_options = array(), $flag = false)
	{
		$ch = $this->_getCurlHandle();
